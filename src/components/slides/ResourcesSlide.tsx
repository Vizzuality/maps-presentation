        ...
        <div className="grid grid-cols-3 gap-5">
          {slide.links.map((l, j) => (
            <motion.a
              ...
              className="glass rounded-2xl p-7 flex items-center gap-5 transition-all duration-200 no-underline"
            ...
            >
              ...
              <p className="font-body text-white font-medium" style={{ fontSize: "1.375rem" }}>{l.name}</p>
            </motion.a>
          ))}
        </div>
      </div>
